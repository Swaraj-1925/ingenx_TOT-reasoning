# Adapted from  https://github.com/microsoft/rStar/blob/main/rstar_deepthink/llms/llm_engine.py
from llms.rm import *
import  torch
...
def rm_engine(config):
    if config.need_value_func:
        ...
        v_head.eval()
        tokenizer = AutoTokenizer.from_pretrained(config.reward_model_dir, trust_remote_code=True, use_cache=False,
